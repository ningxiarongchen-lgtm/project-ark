...
router.route('/invoices')
  .get(authorize('Sales Engineer', 'Sales Manager', 'Administrator'), getInvoices)
  .post(authorize('Sales Manager', 'Administrator'), createInvoice);

router.route('/invoices/:id')
  .get(authorize('Sales Engineer', 'Sales Manager', 'Administrator'), getInvoiceById)
...
router.get('/payments/pending', authorize('Sales Engineer', 'Sales Manager', 'Administrator'), getPendingPayments);
...
router.route('/payments')
  .get(authorize('Sales Engineer', 'Sales Manager', 'Administrator'), getPayments)
  .post(authorize('Sales Manager', 'Administrator'), createPayment);

router.route('/payments/:id')
  .get(authorize('Sales Engineer', 'Sales Manager', 'Administrator'), getPaymentById)
